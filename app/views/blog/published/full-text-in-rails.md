...
موتور جستجو از نوع full-text برای اینکه بتواند نزدیکترین نتیجه را پیدا کند، تمام کلمات موجود در یک سند را جستجو می کند ([wikipedia](http://http://www.sitepoint.com/full-text-search-rails-elasticsearch/en.wikipedia.org/wiki/Full_text_search/)).
...
...
```
حالا جستجوی واژه “drug” با استفاده فهرست وارونه نتایج article#1, article#2 را خواهد داشت. برای اطلاعات بیشتر می توانید به [این](http://example.net/) کتاب مراجعه کنید.

### ساخت یک وبلاگ ساده
در اینجا[مثال مشهوری](http://example.net/) که در راهنمای Rails وجود دارد را با هم پیش می رویم.
...
### نصب در Ubuntu
به [این](http://example.net/) آدرس رفته و فایل deb را دانلود کرده و دستور زیر را اجرا کنید:
